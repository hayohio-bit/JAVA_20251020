...
//		char c2 = 44032;
		...
		float f1 = 10.5f;
		//컴파일러는 실수 리터럴을 기본적으로 double 타입으로 해석하므로 float 타입에 대입하고 싶다면 리터럴 뒤에 F 붙임
		double d1 = 10.5;
		...
		//2.1474836E9 2.1474836x 10 -> 2,147,483,648
		...
		System.out.println("\r" + "캐리지" + "\r" + "리턴");
		System.out.println("\r캐리지\r리턴");
		...
		int num = 130;
		byte b = (byte) num;
		System.out.println(b); //num은 130이므로 byte의 범위(-128~127)를 벗어나 데이터 손실 발생
		 ...
		 * 
		 * 변수명, 클래스명 -> 영문 대소문자, 숫자 특수문자( _ , $ ) 조합에서 만들 수 있음
		 * 단, 숫자는 맨 앞에 기입할 수 없다.
		 * age1 (0)
		 * _age1 (0)
		 * $age1 (0)
